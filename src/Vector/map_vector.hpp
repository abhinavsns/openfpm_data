...
#ifdef SE_CLASS1
			if (base.size() == 0)
			{std::cout << __FILE__ << ":" << __LINE__ << " Warning you are off-loading with toGPU a vector that seem to be empty or not initialized. If you are using Odeint data structs, you can ignore this warning if it is generated by odeint calls" << std::endl; }
#endif
